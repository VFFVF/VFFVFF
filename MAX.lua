...
os.execute('lua MAX.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mارسل معرف المطور الاساسي الان \nDevMax UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mتم حفظ معرف المطور \nDevMax UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ معرف المطور الاساسي \nDevMax UserName not saved\n')
end 
os.execute('lua MAX.lua')
end
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheMAX -X kill
screen -S TheMAX ./TheMAX
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheMAX;chmod +x Run;./Run')
end
...
TheMAX = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheMAX)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheMAX,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,5071753364}  
...
Status = 0
DevMaxsQ = Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",UserId) 
if UserId == 5071753364 then
Status = true
elseif UserId == 5071753364 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheMAX then
Status = true
elseif DevMaxsQ then
Status = true
else
Status = false
end
...
Status = 0
DevMaxs = Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId) 
DevMaxsQ = Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",UserId) 
TheBasics = Redis:sismember(TheMAX.."MAX:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheMAX.."MAX:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheMAX.."MAX:Managers:Group"..ChatId,UserId)
...
elseif DevMaxs then
Status = Redis:get(TheMAX.."MAX:DevMax:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(TheMAX.."MAX:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheMAX.."MAX:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheMAX.."MAX:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheMAX.."MAX:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheMAX.."MAX:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheMAX.."MAX:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheMAX.."MAX:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheMAX.."MAX:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheMAX.."MAX:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheMAX.."MAX:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheMAX.."MAX:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheMAX.."MAX:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheMAX.."MAX:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheMAX.."MAX:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheMAX.."MAX:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheMAX.."MAX:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheMAX.."MAX:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheMAX.."MAX:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheMAX.."MAX:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheMAX.."MAX:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheMAX.."MAX:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheMAX.."MAX:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheMAX.."MAX:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheMAX.."MAX:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheMAX.."MAX:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheMAX.."MAX:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheMAX.."MAX:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheMAX.."MAX:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheMAX.."MAX:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheMAX.."MAX:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheMAX.."MAX:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheMAX.."MAX:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheMAX.."MAX:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheMAX.."MAX:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheMAX.."MAX:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheMAX.."MAX:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[- SOURCE KADI .](https://t.me/vff33)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,T
Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheMAX.."MAX:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMAX.."MAX:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMAX.."MAX:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheMAX.."MAX:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheMAX.."MAX:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheMAX.."MAX:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMAX.."MAX:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheMAX.."MAX:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheMAX.."MAX:Game:Difference"..msg.chat_id) then 
Redis:del(TheMAX.."MAX:Game:Difference"..msg.chat_id)
Redis:incrby(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheMAX.."MAX:Game:Example"..msg.chat_id) then
if text == Redis:get(TheMAX.."MAX:Game:Example"..msg.chat_id) then 
Redis:del(TheMAX.."MAX:Game:Example"..msg.chat_id)
Redis:incrby(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if MaxJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMAX..'MAX:Max:Join')}, },}}
...
if tonumber(TheMAX) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheMAX..'MAX:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheMAX.."MAX:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheMAX.."MAX:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheMAX.."MAX:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheMAX.."MAX:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheMAX.."MAX:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheMAX) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheMAX.."MAX:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheMAX.."MAX:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheMAX.."MAX:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheMAX.."MAX:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheMAX..'MAX:Max:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheMAX..'MAX:Max:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local MaxUser = text:gsub('@','')
if UserId_Info.type.is_Max == true then
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheMAX).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheMAX..'MAX:Max:Join',MaxUser) 
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم تعيين الاشتراك الاجباري على قناة : [@"..MaxUser..']',"md",true)  
else
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙هاذا ليس معرف قناة يرجى ارسال معرف القناة الصحيح: [@"..MaxUser..']',"md",true)  
end
end
end
...
Redis:set(TheMAX..'MAX:Max:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
local Max = Redis:get(TheMAX..'MAX:Max:Join')
if Max then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙الاشتراك الاجباري مفعل على : [@"..Max..']',"md",true)  
else
...
--download('https://raw.githubusercontent.com/SourceTheMAX/TheMAX/master/MAX.lua','MAX.lua')
...
local Groups = Redis:smembers(TheMAX..'MAX:ChekBotAdd')  
local UsersBot = Redis:smembers(TheMAX..'MAX:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheMAX..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheMAX.."MAX:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheMAX.."MAX:Originators:Group"..v)
local Manager = Redis:smembers(TheMAX.."MAX:Managers:Group"..v)
local Admin = Redis:smembers(TheMAX.."MAX:Addictive:Group"..v)
local Vips = Redis:smembers(TheMAX.."MAX:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheMAX.."MAX:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheMAX.."MAX:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheMAX.."MAX:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheMAX.."MAX:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheMAX.."MAX:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheMAX..'MAX:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheMAX..'MAX:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheMAX..'MAX:Num:User:Pv') or 0)..'*',"md",true)  
end
if text == 'تفعيل' and msg.DevMaxs then
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(TheMAX.."MAX:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheMAX..'MAX:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheMAX..'MAX:Num:Add:Bot'),"md",true)  
end
...
{
{text = '『 𝗦𝗢𝗨𝗥𝗖𝗘 𝗞𝗔𝗗𝗜』', url = 't.me/vff33'},
},
}
}
if not msg.ControllerBot then
...
Redis:sadd(TheMAX.."MAX:ChekBotAdd",msg_chat_id)
Redis:set(TheMAX.."MAX:Status:Id"..msg_chat_id,true) ;Redis:set(TheMAX.."MAX:Status:Reply"..msg_chat_id,true) ;Redis:set(TheMAX.."MAX:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheMAX.."MAX:Status:BanId"..msg_chat_id,true) ;Redis:set(TheMAX.."MAX:Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n᥀︙تم تفعيل المجموعه *','md', true, false, false, false, reply_markup)
end
end 
if text == 'تفعيل' and not msg.DevMaxs then
if msg.can_be_deleted_for_all_users == false then
return LuaTele.sendText(msg_chat_id,msg_id,"\n*᥀︙عذرآ البوت ليس ادمن في المجموعه يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  
end
...
if not Redis:get(TheMAX.."MAX:BotFree") then
...
if text == 'تعطيل' and msg.DevMaxs then
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheMAX.."MAX:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheMAX.."MAX:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n᥀︙تم تعطيلها بنجاح *','md',true)
end
end
if text == 'تعطيل' and not msg.DevMaxs then
local StatusMember = LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele
if (StatusMember == "chatMemberStatusCreator") then
local AddedBot = true
elseif (StatusMember == "chatMemberStatusAdministrator") then
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheMAX.."MAX:ChekBotAdd",msg_chat_id) then
Redis:incr(TheMAX..'MAX:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" and msg.reply_to_message_id == 0 then
if MaxJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMAX..'MAX:Max:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n᥀︙عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end 
if not Redis:get(TheMAX.."MAX:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(TheMAX..'MAX:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheMAX..'MAX:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheMAX.."MAX:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheMAX.."MAX:Set:Id:Group"..msg_chat_id)
if Redis:get(TheMAX.."MAX:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheMAX..'MAX:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheMAX..'MAX:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheMAX..'MAX:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheMAX..'MAX:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*᥀︙ايديه : '..UserId..
'\n᥀︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheMAX).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheMAX).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevMaxsQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevMaxs:Groups",UserId_Info.id) 
...
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" and not msg.DevMaxs then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(2)..' , مالك الكروب }* ',"md",true)  
end
if not Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله منشئ اساسي ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if not msg.DevMaxs then
...
if not Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:DevMaxsQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevMaxs:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevMaxsQ:Groups",UserId) 
...
if not Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:DevMaxs:Groups",UserId) 
...
if not Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevMaxsQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevMaxs:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMAX.."MAX:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMAX.."MAX:DevMaxsQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:DevMaxsQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevMaxs:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:DevMaxs:Groups",UserId) 
...
if Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheMAX.."MAX:DevMax:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMAX.."MAX:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMAX.."MAX:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMAX.."MAX:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheMAX.."MAX:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMAX.."MAX:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheMAX.."MAX:DevMaxsQ:Groups") 
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطورين الثانويين', data = msg.sender.user_id..'/DevMaxsQ'},},}}
...
local Info_Members = Redis:smembers(TheMAX.."MAX:DevMaxs:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح المطورين', data = msg.sender.user_id..'/DevMaxs'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if text == 'المنشئين الاساسيين' then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" or not msg.DevMaxs then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(2)..' }* ',"md",true)  
end
if MaxJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMAX..'MAX:Max:Join')}, },}}
...
local Info_Members = Redis:smembers(TheMAX.."MAX:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheMAX.."MAX:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheMAX.."MAX:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:BotFree",true) 
...
Redis:set(TheMAX.."MAX:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheMAX.."MAX1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMAX.."MAX1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMAX.."MAX1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheMAX..'MAX1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheMAX..'MAX1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheMAX..'MAX1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheMAX.."MAX1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMAX.."MAX1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheMAX.."MAX1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheMAX.."MAX1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheMAX.."MAX1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheMAX.."MAX1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheMAX.."MAX1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMAX.."MAX1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMAX.."MAX1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMAX.."MAX1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMAX.."MAX1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMAX.."MAX1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheMAX.."MAX1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheMAX.."MAX1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheMAX.."MAX1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheMAX.."MAX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMAX.."MAX11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMAX.."MAX11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheMAX..'MAX11:Add:Rd:Sudo:Text'..text)
Redis:del(TheMAX..'MAX11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheMAX..'MAX11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheMAX.."MAX11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMAX.."MAX11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheMAX.."MAX11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheMAX.."MAX11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheMAX.."MAX11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheMAX.."MAX11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheMAX.."MAX11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheMAX.."MAX11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMAX.."MAX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheMAX.."MAX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheMAX.."MAX11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMAX.."MAX11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMAX.."MAX11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheMAX.."MAX11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheMAX.."MAX11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheMAX.."MAX11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheMAX.."MAX:allM"..msg.chat_id, msg.id)
if Redis:get(TheMAX.."MAX:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheMAX.."MAX:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheMAX.."MAX:allM"..msg.chat_id)
...
Redis:del(TheMAX.."MAX:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheMAX.."MAX:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheMAX.."MAX:allM"..msg.chat_id)  
...
Redis:del(TheMAX.."MAX:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheMAX.."MAX:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheMAX.."MAX:Status:yt"..msg.chat_id)
...
Redis:set(TheMAX.."MAX:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheMAX.."MAX:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheMAX.."MAX:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheMAX.."MAX:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:Id"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:Reply"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:BanId"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(TheMAX.."MAX:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheMAX.."MAX:Status:KickMe"..msg_chat_id) 
...
if not Redis:sismember(TheMAX.."MAX:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMAX.."MAX:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMAX.."MAX:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMAX.."MAX:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheMAX.."MAX:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMAX.."MAX:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(TheMAX.."MAX:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheMAX.."MAX:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheMAX.."MAX:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheMAX.."MAX:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheMAX.."MAX:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheMAX.."MAX:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheMAX.."MAX:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMAX..'MAX:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheMAX.."MAX:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:Lock:text"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:Lock:Join"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:lockpin"..msg_chat_id)  
...
Redis:del(TheMAX.."MAX:Lock:edit"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheMAX..'MAX:'..lock..msg_chat_id)    
end
...
if not Redis:get(TheMAX.."knele"..msg.chat_id) then
Abs = math.random(4,2824); 
local Text ='*✯︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '✯ 𝗦𝗼𝘂𝗿𝗰𝗲 𝗞𝗔𝗗𝗜.',url="t.me/vff33"}}} 
...
Redis:hset(TheMAX.."MAX:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheMAX.."MAX:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheMAX.."MAX:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheMAX.."MAX:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheMAX.."MAX:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheMAX.."MAX:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Link"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Video"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:geam"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:vico"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:forward"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Document"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheMAX.."MAX:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheMAX.."MAX:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheMAX.."MAX:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheMAX.."MAX:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheMAX.."MAX:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheMAX.."MAX:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheMAX.."MAX:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheMAX.."MAX:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheMAX.."MAX:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(TheMAX.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheMAX.."MAX:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheMAX.."MAX:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheMAX.."MAX:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheMAX.."MAX:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheMAX.."MAX:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheMAX.."MAX:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMAX.."MAX:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheMAX.."MAX:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheMAX.."MAX:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheMAX.."MAX:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheMAX.."MAX:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheMAX..'MAX:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheMAX..'MAX:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheMAX.."MAX:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheMAX.."MAX:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheMAX.."MAX:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheMAX.."MAX:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheMAX.."MAX:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheMAX.."MAX:Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- 𝘀𝗼𝘂𝗿𝗰𝗲 𝗺𝗮𝘅', url = 't.me/vff33'}, 
},
}
}
...
Rink = 1
elseif Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheMAX.."MAX:DevMaxs:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheMAX.."MAX:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheMAX.."MAX:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheMAX.."MAX:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheMAX.."MAX:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheMAX.."MAX:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheMAX..'MAX:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheMAX..'MAX:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheMAX..'MAX:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheMAX..'MAX:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheMAX..'MAX:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheMAX.."MAX:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheMAX.."MAX:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
...
Redis:del(TheMAX.."MAX:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheMAX.."MAX:DevMaxsQ:Groups") 
...
Redis:del(TheMAX.."MAX:DevMaxs:Groups") 
...
Redis:del(TheMAX.."MAX:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Originators:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Managers:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:BanAll:Groups") 
...
Redis:del(TheMAX.."MAX:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheMAX.."MAX:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheMAX.."MAX:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheMAX.."MAX:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheMAX.."MAX:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheMAX.."MAX:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheMAX.."MAX:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheMAX.."MAX:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMAX.."MAX:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMAX.."MAX:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheMAX.."MAX:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:vico"..v)   
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:Text"..v)   
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:Photo"..v)
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:Video"..v)
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:File"..v)
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:Audio"..v)
Redis:del(TheMAX.."MAX:Add:Rd:Sudo:video_note"..v)
Redis:del(TheMAX.."MAX:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheMAX.."MAX:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheMAX.."MAX:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMAX.."MAX:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMAX.."MAX:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheMAX.."MAX:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMAX.."MAX:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMAX.."MAX:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMAX.."MAX:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheMAX.."MAX:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMAX..'MAX:GetTexting:DevTheMAX'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheMAX..'MAX:Texting:DevTheMAX')
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙ تم حذف كليشه المطور')
end
if text == 'المطور' or text == 'مطور' then
local TextingDevTheMAX = Redis:get(TheMAX..'MAX:Texting:DevTheMAX')
if TextingDevTheMAX then 
return LuaTele.sendText(msg_chat_id,msg_id,TextingDevMAX,"md",true)  
else
...
{
{text = '.َ ‹ 𝗦𝗼𝘂𝗿𝗰𝗲 MAX ⁦⁦.𖨬', url = "https://t.me/vff33"}
},
}
...
{
{text = '༄ DevMax', url = "https://t.me/VFF11"},{text = ' ༄ Exp Source .', url = "https://t.me/vff33"}
},
{
{text = ' ༄ Tws 𝗠𝗔𝗫   〠', url = "https://t.me/YFF11bot"}
},
{
{text = ' ༄ Source Max', url = "https://t.me/vff33"}
},
}
local msgg = msg_id/2097152/0.5
...
Redis:setex(TheMAX.."MAX:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheMAX.."MAX:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheMAX.."MAX:Name:Bot") or "كادي") then
local NamesBot = (Redis:get(TheMAX.."MAX:Name:Bot") or "كادي")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(TheMAX..'MAX:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheMAX)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheMAX..'MAX:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheMAX..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheMAX..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheMAX..'MAX:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheMAX.."MAX:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheMAX.."MAX:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheMAX.."MAX:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheMAX.."MAX:Status:Games"..msg.chat_id) then
Redis:del(TheMAX.."MAX:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheMAX.."MAX:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheMAX.."MAX:Status:Games"..msg.chat_id) then
Redis:del(TheMAX.."MAX:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheMAX.."MAX:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheMAX.."MAX:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheMAX.."MAX:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheMAX.."MAX:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheMAX.."MAX:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheMAX.."MAX:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheMAX.."MAX:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheMAX.."MAX:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheMAX..'MAX:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheMAX.."MAX:Start:Bot") then
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheMAX.."MAX:Name:Bot") or "كادي")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/vff33'},{text = '᥀ لتنصيب بوت .', url = 't.me/VFF11'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheMAX.."MAX:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheMAX.."MAX:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheMAX.."MAX:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(TheMAX.."MAX:TwaslBot") and not Redis:sismember(TheMAX.."MAX:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheMAX.."MAX:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheMAX.."MAX:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheMAX..'MAX:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheMAX..'MAX:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheMAX.."MAX:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheMAX..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheMAX.."MAX:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMAX.."MAX:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheMAX.."MAX:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheMAX then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheMAX..'MAX:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheMAX.."MAX:Lock:edit"..data.chat_id) then
...
Redis:incrby(TheMAX.."MAX:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMAX.."MAX:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMAX.."MAX:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMAX.."MAX:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMAX.."MAX:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMAX.."MAX:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMAX.."MAX:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMAX.."MAX:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheMAX.."MAX:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMAX..'MAX:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheMAX.."MAX:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"᥀︙تم فتح التكرار").unLock, 'md', true, false, reply_markup)
end
end
if Text and Text:match('(%d+)/DevMaxs') then
local UserId = Text:match('(%d+)/DevMaxs')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:DevMaxs:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح مطورين البوت", 'md', false)
end
elseif Text and Text:match('(%d+)/DevMaxsQ') then
local UserId = Text:match('(%d+)/DevMaxsQ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:DevMaxsQ:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMAX.."MAX:SilentGroup:Group"..ChatId) 
